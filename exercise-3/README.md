...
R = El primero número es 0, esto ya que al hacer la división para el primer dígito, el dividnedo es menor que el divisor, y la salida del número 1763 es: 0   1   7   6   3
